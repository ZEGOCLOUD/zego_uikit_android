...
class SimpleExpressEventHandler extends IZegoEventHandler {
    ...
    public void onPlayerSwitched(String streamID, int errorCode) {
        ...
        for (IZegoEventHandler handler : handlerList) {
            handler.onPlayerSwitched(streamID, errorCode);
        }
    }
    ...
    public void onRecvRoomTransparentMessage(String roomID, ZegoRoomRecvTransparentMessage message) {
        ...
        for (IZegoEventHandler handler : handlerList) {
            handler.onRecvRoomTransparentMessage(roomID, message);
        }
    }
    ...
    public void onRequestUploadDumpData(String dumpDir, boolean takePhoto) {
        ...
        for (IZegoEventHandler handler : handlerList) {
            handler.onRequestUploadDumpData(dumpDir, takePhoto);
        }
    }
    ...
    public void onStartDumpData(int errorCode) {
        ...
        for (IZegoEventHandler handler : handlerList) {
            handler.onStartDumpData(errorCode);
        }
    }
    ...
    public void onStopDumpData(int errorCode, String dumpDir) {
        ...
        for (IZegoEventHandler handler : handlerList) {
            handler.onStopDumpData(errorCode, dumpDir);
        }
    }
    ...
    public void onUploadDumpData(int errorCode) {
        ...
        for (IZegoEventHandler handler : handlerList) {
            handler.onUploadDumpData(errorCode);
        }
    }
